...
router.get('/get/:p_id', async (req, res) => {
  ...
  const selectQuery = 'SELECT p_id, p_name, p_location, p_simplelocation, p_region, p_latitude, p_longitude, p_startdate, p_enddate, p_status, p_intro, p_detail, p_interest, p_imageurl FROM popupstore WHERE p_id = ?';
